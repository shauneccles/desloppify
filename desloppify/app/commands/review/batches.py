    ...
    *,
    ...
    def _write_run_summary(
        *,
        ...
        safe_write_text_fn(run_summary_path, orjson.dumps(run_summary, option=orjson.OPT_INDENT_2).decode("utf-8") + "\n")
    ...
    safe_write_text_fn(merged_path, orjson.dumps(merged, option=orjson.OPT_INDENT_2).decode("utf-8") + "\n")
